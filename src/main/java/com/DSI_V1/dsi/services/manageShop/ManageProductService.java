...
public class ManageProductService {
    ...
    public int createProduct(String nameProduct, double price, int user_id, String description, int brand_id, String thumb,int shopper_id,LocalDateTime created_at) {
        return productReposity.createProduct(nameProduct, price, user_id, description, brand_id, thumb,shopper_id,created_at);
    }
    ...
    public int updateProduct(String name_product, double price, String description, int brand_id, String thumb, LocalDateTime updated_at, int product_id){
        return productReposity.updateProduct(name_product,price,description,brand_id,thumb,updated_at,product_id);
    }
